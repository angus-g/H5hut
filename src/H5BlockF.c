...
f_h5bl_get_proc_of (
	...
	return H5Block3dGetProcOf ( f, *i, *j, *k );
}
...
f_h5bl_3d_read_scalar_field (
	...
	h5part_int64_t herr = H5Block3dReadScalarField ( f, field_name2, data );
...
f_h5bl_3d_write_scalar_field (
	...
	h5part_int64_t herr = H5Block3dWriteScalarField ( f, field_name2, data );
...
f_h5bl_getfieldinfo (
	...
	h5part_int64_t herr = H5BlockGetFieldInfo (
		f, *idx, field_name, l_field_name, grid_rank, grid_dims, field_dims );
...
f_h5bl_writefieldattrib_r8 (
	...
	h5part_int64_t herr = H5BlockWriteFieldAttrib (
		f, field_name2, attrib_name2, H5PART_FLOAT64,
...
f_h5bl_writefieldattrib_i8 (
	...
	h5part_int64_t herr = H5BlockWriteFieldAttrib (
		f, field_name2, attrib_name2, H5PART_INT64,
		attrib_value, *attrib_nelem );
...
f_h5bl_writefieldattrib_string (
	...
	h5part_int64_t herr = H5BlockWriteFieldAttribString (
		f, field_name2, attrib_name2, attrib_value2 );
